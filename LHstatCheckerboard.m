...
clear all;close all
kNN = 1;
%addpath('C:\Users\abre5582\OneDrive - The University of Sydney (Staff)\code\Will\resources_wdav')

% elSolute = {'Zr','Nb','Cu','Al','Ni','Hf'};
% 
% elSolute = {'Cu'};
% elSolute = {'Zr','Ni','Al','Ti','Cu'};
% elSolute = {'Mg','Cu'};
% elSolute = {'Cr','Fe','Mn','Ni','Co'};
% elSolute = {'Co','Cr','Ni'};
elSolute = {'Al','V','Fe','O'};
%elSolute = {''};
...
runPairsOnly = true;
saveOutput = true; filename = 'testSLM_1NN_10sims';
...
%% Save data 
if saveOutput 
   save(filename,'idxSolute','names','pLH','pLELHu','pLELHl','pNLH','edges','Giw','Gbar','Ghat','edgeLE','nRsave','nSave') 
end
...
%% Plotting from reading in off a figure 
